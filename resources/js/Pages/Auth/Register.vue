    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-6 flex flex-col items-center justify-center gap-4">
                ...
                <a href="/auth/google" class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-stone-750 rounded-md text-sm font-medium text-stone-200 bg-stone-900/50 hover:bg-stone-800 hover:text-white transition duration-150 focus:outline-none focus:ring-2 focus:ring-amber-500">
